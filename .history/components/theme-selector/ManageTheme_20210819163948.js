...
export default function ManageTheme({
    ...
    const [primaryButtonColor, setPrimaryButtonColor] = useState('#EBE8FF');
    const [primaryButtonBgColor, setPrimaryButtonBgColor] = useState('#4D1AFF');
    const [secondaryButtonColor, setSecondaryButtonColor] = useState('#1C2B4D');

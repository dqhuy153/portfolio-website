...
export default function MediaDesc({
    ...
    className,
    delayY, //use to calc right offsetTop (element change when use transformY) //tricky
    ...
    useEffect(() => {
        ...
        window.addEventListener('scroll', () => {
            if (
                offsetTop - clientHeight < window.scrollY &&
                window.scrollY < offsetHeight + offsetTop + clientHeight
            ) {
        ...
        // console.log('top: ' + containerRef.current.offsetTop);

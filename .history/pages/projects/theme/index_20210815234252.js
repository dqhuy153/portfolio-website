...
import { getFromLS, setToLS } from '../../../util/storage/LocalStorage';
import styles from './theme-selector.module.scss';

export default function ThemePage(props) {
    const { theme, themes, themeLoaded, setMode, getFonts } = useTheme();

    console.log(theme);
    console.log(themes);
    console.log(themeLoaded);
    console.log(setMode('T002'));
    ...
    return (
        <>
            ...
            <Section primaryColor="#339489" background="#fff">
                {/* Navigation */}
                <Navigation1
                    items={[

...
import Contact from '../../../components/theme-selector/section/Contact';
import Home from '../../../components/theme-selector/section/Home';
import Projects from '../../../components/theme-selector/section/Projects';
    ...
    return (
        <>
            ...
            <main>
                ...
                />
                {/* Home Section */}
                <Home id="home" className={styles['section-container']}></Home>
                {/* About Section */}
                <About
                    id="about"

...
import Contact from '../../../components/theme-selector/Contact';
import Home from '../../../components/theme-selector/Home';
import Projects from '../../../components/theme-selector/Projects';
    ...
    return (
        <>
            ...
            <main>
                ...
                />
                {/* Home Section */}
                <Home className={styles['section-container']}></Home>
                {/* About Section */}
                <About className={styles['section-container']}></About>
                {/* Projects Section */}
                <Projects className={styles['section-container']}></Projects>
                {/* Contact Section */}
                <Contact className={styles['section-container']}></Contact>
            </main>
        </>
    );
}

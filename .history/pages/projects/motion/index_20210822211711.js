...
export default function MotionPage(props) {
    ...
    const [translateYFooter, setTranslateYFooter] = useState(-100);
    ...
    useEffect(() => {
        window.addEventListener('scroll', () => {
            ...
            if (
                ...
                console.log(window.scrollY + footerRef.current.clientHeight);
                console.dir(footerRef.current.offsetTop);
            }
        });

          ...
          <>
            ...
            <section className={`${styles.home} ${styles.section}`}>
              <animated.p style={pHomeAnimated}>
                Motion is a digital brand agency that lives where design,
                technology, and experience collide. We are obsessed with
                creativity — challenging what is, while defining what comes
                next.
              </animated.p>
            </section>
            ...
            <section>
              ...
              <MediaDesc
                ...
                delayYBefore={-430} //offsetTop - offsetHeight - actual offsetTop
                delayYAfter={-430}
              >
                <div className={styles['image-desc']}>
                  <h2>Ensembl</h2>
              ...
              >
                <div className={styles['image-desc']}>
                  ...
                  <p>A modern way to experience classical art</p>
                  <Link1
                    href="/projects/motion/agency"
                    title="View the project"
                    justifyContent="flex-start"
            ...
            >
              {!isMobile && (
                <animated.p style={pPreEndAnimated}>
                  We fuse insights, opportunities, and unexpected expressions
                  into resonant brand experiences.
                </animated.p>
              )}
              {isMobile && (
                <p>
